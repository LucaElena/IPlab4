...
public class InstagramPost implements Postare {
    ...
    public InstagramPost(String url, String text, List<String> attachments, List<Pair<User, Reaction>> reactions, List<Pair<User, Share>> share, int impacts) {
        this.url = url;
        this.text = text;
